...
mongo_password = st.secrets["MONGODB_PASSWORD"]

# 2. Monte a URI utilizando a variável limpa
uri = f"mongodb+srv://medphys_user:{mongo_password}@cluster0.dl2yo1n.mongodb.net/?appName=Cluster0"
